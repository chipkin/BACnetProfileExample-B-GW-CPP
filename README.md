...
**Confirmed working, on the live wire, against this build** (bacpypes3):
...
[v1.0.0](https://github.com/chipkin/BACnetProfileExample-B-GW-CPP/releases/tag/v1.0.0)
...
v1.0.0 was published from a prebuilt STATIC-linked stack library rather than
the SOURCE-mode build documented above; the next release refreshes these
numbers from the documented build.
